...
bool kobuki_ros_interfaces__msg__version_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kobuki_ros_interfaces.msg._version_info.VersionInfo", full_classname_dest, 51) == 0);
  }
  kobuki_ros_interfaces__msg__VersionInfo * ros_message = _ros_message;
  {  // hardware
  ...
  {  // udid
    PyObject * field = PyObject_GetAttrString(_pymsg, "udid");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint32_t * dest = ros_message->udid.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'udid'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // features
    ...
    ros_message->features = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * kobuki_ros_interfaces__msg__version_info__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VersionInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kobuki_ros_interfaces.msg._version_info");
  ...
  kobuki_ros_interfaces__msg__VersionInfo * ros_message = (kobuki_ros_interfaces__msg__VersionInfo *)raw_ros_message;
  {  // hardware
    PyObject * field = NULL;
  ...
  {  // udid
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "udid");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->udid.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->udid.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->udid.size * sizeof(uint32_t));
      assert(data != NULL);
  ...
  {  // features
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->features);
    {
