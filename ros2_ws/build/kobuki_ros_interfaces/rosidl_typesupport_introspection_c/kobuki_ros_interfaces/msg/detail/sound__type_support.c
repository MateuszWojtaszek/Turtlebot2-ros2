  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  kobuki_ros_interfaces__msg__Sound__init(message_memory);
}

void Sound__rosidl_typesupport_introspection_c__Sound_fini_function(void * message_memory)
{
  kobuki_ros_interfaces__msg__Sound__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Sound__rosidl_typesupport_introspection_c__Sound_message_member_array[1] = {
  {
    ...
    offsetof(kobuki_ros_interfaces__msg__Sound, value),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Sound__rosidl_typesupport_introspection_c__Sound_message_members = {
  ...
  "Sound",  // message name
  1,  // number of fields
  sizeof(kobuki_ros_interfaces__msg__Sound),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kobuki_ros_interfaces, msg, Sound)() {
