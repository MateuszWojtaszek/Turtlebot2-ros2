  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  kobuki_ros_interfaces__msg__Led__init(message_memory);
}

void Led__rosidl_typesupport_introspection_c__Led_fini_function(void * message_memory)
{
  kobuki_ros_interfaces__msg__Led__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Led__rosidl_typesupport_introspection_c__Led_message_member_array[1] = {
  {
    "value",  // name
    ...
    offsetof(kobuki_ros_interfaces__msg__Led, value),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Led__rosidl_typesupport_introspection_c__Led_message_members = {
  ...
  "Led",  // message name
  1,  // number of fields
  sizeof(kobuki_ros_interfaces__msg__Led),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kobuki_ros_interfaces, msg, Led)() {
