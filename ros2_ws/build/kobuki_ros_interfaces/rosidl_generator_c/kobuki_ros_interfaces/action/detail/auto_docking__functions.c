...
{
  kobuki_ros_interfaces__action__AutoDocking_Goal * msg = (kobuki_ros_interfaces__action__AutoDocking_Goal *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_Goal));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_Goal__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_Goal *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_Goal));
    if (!data) {
      return false;
    }
...
{
  kobuki_ros_interfaces__action__AutoDocking_Goal__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_Goal__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_Goal__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  kobuki_ros_interfaces__action__AutoDocking_Result * msg = (kobuki_ros_interfaces__action__AutoDocking_Result *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_Result));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_Result__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_Result *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  kobuki_ros_interfaces__action__AutoDocking_Result__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_Result__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_Result__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  kobuki_ros_interfaces__action__AutoDocking_Feedback * msg = (kobuki_ros_interfaces__action__AutoDocking_Feedback *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_Feedback));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_Feedback__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_Feedback *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  kobuki_ros_interfaces__action__AutoDocking_Feedback__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_Feedback__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request * msg = (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response * msg = (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  kobuki_ros_interfaces__action__AutoDocking_GetResult_Request * msg = (kobuki_ros_interfaces__action__AutoDocking_GetResult_Request *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_GetResult_Request *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  kobuki_ros_interfaces__action__AutoDocking_GetResult_Response * msg = (kobuki_ros_interfaces__action__AutoDocking_GetResult_Response *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_GetResult_Response *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage * msg = (kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__Sequence__init(kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage *)calloc(size, sizeof(kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__Sequence * array = (kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__Sequence *)malloc(sizeof(kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
