...
{
  kobuki_ros_interfaces__msg__VersionInfo * msg = (kobuki_ros_interfaces__msg__VersionInfo *)malloc(sizeof(kobuki_ros_interfaces__msg__VersionInfo));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__msg__VersionInfo__Sequence__init(kobuki_ros_interfaces__msg__VersionInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__msg__VersionInfo *)calloc(size, sizeof(kobuki_ros_interfaces__msg__VersionInfo));
    if (!data) {
      return false;
    }
...
{
  kobuki_ros_interfaces__msg__VersionInfo__Sequence * array = (kobuki_ros_interfaces__msg__VersionInfo__Sequence *)malloc(sizeof(kobuki_ros_interfaces__msg__VersionInfo__Sequence));
  if (!array) {
    return NULL;
  }
