...
{
  kobuki_ros_interfaces__msg__SensorState * msg = (kobuki_ros_interfaces__msg__SensorState *)malloc(sizeof(kobuki_ros_interfaces__msg__SensorState));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__msg__SensorState__Sequence__init(kobuki_ros_interfaces__msg__SensorState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__msg__SensorState *)calloc(size, sizeof(kobuki_ros_interfaces__msg__SensorState));
    if (!data) {
      return false;
    }
...
{
  kobuki_ros_interfaces__msg__SensorState__Sequence * array = (kobuki_ros_interfaces__msg__SensorState__Sequence *)malloc(sizeof(kobuki_ros_interfaces__msg__SensorState__Sequence));
  if (!array) {
    return NULL;
  }
