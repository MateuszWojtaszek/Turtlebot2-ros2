...
{
  kobuki_ros_interfaces__msg__WheelDropEvent * msg = (kobuki_ros_interfaces__msg__WheelDropEvent *)malloc(sizeof(kobuki_ros_interfaces__msg__WheelDropEvent));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__msg__WheelDropEvent__Sequence__init(kobuki_ros_interfaces__msg__WheelDropEvent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__msg__WheelDropEvent *)calloc(size, sizeof(kobuki_ros_interfaces__msg__WheelDropEvent));
    if (!data) {
      return false;
    }
...
{
  kobuki_ros_interfaces__msg__WheelDropEvent__Sequence * array = (kobuki_ros_interfaces__msg__WheelDropEvent__Sequence *)malloc(sizeof(kobuki_ros_interfaces__msg__WheelDropEvent__Sequence));
  if (!array) {
    return NULL;
  }
