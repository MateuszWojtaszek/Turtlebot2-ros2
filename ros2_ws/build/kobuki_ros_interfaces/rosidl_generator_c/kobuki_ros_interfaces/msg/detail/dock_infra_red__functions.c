...
{
  kobuki_ros_interfaces__msg__DockInfraRed * msg = (kobuki_ros_interfaces__msg__DockInfraRed *)malloc(sizeof(kobuki_ros_interfaces__msg__DockInfraRed));
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__msg__DockInfraRed__Sequence__init(kobuki_ros_interfaces__msg__DockInfraRed__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__msg__DockInfraRed *)calloc(size, sizeof(kobuki_ros_interfaces__msg__DockInfraRed));
    if (!data) {
      return false;
    }
...
{
  kobuki_ros_interfaces__msg__DockInfraRed__Sequence * array = (kobuki_ros_interfaces__msg__DockInfraRed__Sequence *)malloc(sizeof(kobuki_ros_interfaces__msg__DockInfraRed__Sequence));
  if (!array) {
    return NULL;
  }
