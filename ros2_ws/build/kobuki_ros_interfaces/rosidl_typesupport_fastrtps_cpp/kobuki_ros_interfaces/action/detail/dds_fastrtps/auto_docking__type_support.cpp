...
{
  return max_serialized_size_AutoDocking_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_AutoDocking_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_AutoDocking_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_AutoDocking_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_AutoDocking_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_AutoDocking_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_AutoDocking_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_AutoDocking_FeedbackMessage(full_bounded, 0);
}
